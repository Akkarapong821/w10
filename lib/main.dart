...
class Test extends StatelessWidget {
  ...
  final List<Insta> InstaList = [
    Insta(imguser: 'assets/images/iulogo.JPG', img: 'assets/images/IU.JPG',
        caption: "@gucci🦎🦎",
        userpost: 'dlwlrma', comments:
        [Comments(user: 'zhunnio', comment: "♥♥"),
          Comments(user: 'pce.sr', comment: 'SO PRETTY ❤')],
        ),
    Insta(imguser: 'assets/images/theboyzlogo.jpg', img: 'assets/images/YH.PNG',
      caption: '잘자 THE B ❤ \n #YH',
        userpost: 'official_theboyz',comments:
        [Comments(user: 'pnp.lixn', comment: 'GN♥'),
          Comments(user: 'choki', comment: '💚💚💚')],
        ),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text('Insta',
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                    child: Text(
                        '${widget.insta.userpost}',style: TextStyle(fontWeight: FontWeight.bold),
                    )
                ),
